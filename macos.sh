...
sudo scutil --set ComputerName "marks macbook pro"
sudo scutil --set HostName "marks-macbook-pro"
sudo scutil --set LocalHostName $(scutil --get HostName)
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string $(scutil --get HostName)
...
# System Preferences > Trackpad > Tap to click (also for login screen)
